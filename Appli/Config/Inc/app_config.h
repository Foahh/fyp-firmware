...
/* Default runtime thresholds for tracker configuration. */
#define PP_TRACK_DEFAULT_TRACK_THRESH 0.25f
#define PP_TRACK_DEFAULT_DET_THRESH   0.8f
#define PP_TRACK_DEFAULT_SIM1_THRESH  0.8f
#define PP_TRACK_DEFAULT_SIM2_THRESH  0.5f
#define PP_TRACK_DEFAULT_TLOST_CNT    60U
...
#define AI_OD_ST_YOLOX_PP_MAX_BOXES_LIMIT  PROTO_DETECTION_RESULT_MAX_DETECTIONS
...
#define AI_OD_YOLOV8_PP_MAX_BOXES_LIMIT PROTO_DETECTION_RESULT_MAX_DETECTIONS
...
#define AI_OD_YOLO_D_PP_MAX_BOXES_LIMIT PROTO_DETECTION_RESULT_MAX_DETECTIONS
