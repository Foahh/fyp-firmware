...
- `Sensor/` — External sensors
  - `Src/tof.c` — VL53L5CX 8x8 depth ranging; splits NN detections by class (hand=0, tool=1) and raises proximity alert when a hand is within threshold of a tool
...
- `Config/Inc/` — Build-time configuration (`cam_config.h`, `lcd_config.h`, `nn_config.h`, `app_config.h`, `model_config.h`)
  - `models/` — Per-model constant headers (`model_yolox_nano_480_coco_person.h`, `model_st_yolodv2milli_256_coco_person.h`, `model_yolo26_320_coco_person.h`, `model_yolo26_320_fyp_merged.h`)
...
- Model selection passed as compile define (e.g. `MODEL_YOLO26_320_FYP_MERGED`) via `-DMODEL_DEFINE` from `build.py`; each model's header in `Config/Inc/models/` binds the generated stai symbols and post-processing parameters
